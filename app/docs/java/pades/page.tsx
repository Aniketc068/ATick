...
export const metadata: Metadata = { title: 'PAdES levels · Java', description: 'PAdES levels, RFC-3161 timestamps, LTV (DSS) and PAdES-B-LTA document timestamps with ATick for Java.', alternates: { canonical: '/docs/java/pades/' } };

export default function Page() {
  return (
    <DocsShell lang="java" section="pades">
      <h1>PAdES levels</h1>
      ...
      <p>Options are passed as a JSON string. Failures throw <code>Atick.AtickException</code>.</p>
      <Code lang="java" file="PadesLevels.java" code={`import io.github.aniketc068.atick.Atick;
...
Files.write(Path.of("signed.pdf"), blta);`} />
      ...
      (<code>&quot;sha256&quot;</code>, <code>&quot;sha384&quot;</code>, or
      <code> &quot;sha512&quot;</code>).</p>
      <Code lang="java" file="CustomTsa.java" code={`import io.github.aniketc068.atick.Atick;
import java.nio.file.*;
...
byte[] signed = Atick.signPfx(pdf, pfx,
      ...
      custom TSA.</p>
      <Code lang="java" file="DocTimestamp.java" code={`import io.github.aniketc068.atick.Atick;
import java.nio.file.*;
...
Files.write(Path.of("signed-lta.pdf"), archived);`} />
      ...
      <p><a href="/docs/java/appearance/">Next page →</a></p>
    </DocsShell>
  );
}
