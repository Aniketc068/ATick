...
export const metadata: Metadata = { title: 'API reference · Java', description: 'Complete API reference for ATick for Java — every function, option and attribute.', alternates: { canonical: '/docs/java/api/' } };
