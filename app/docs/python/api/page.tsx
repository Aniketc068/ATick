...
export const metadata: Metadata = { title: 'API reference · Python', description: 'Complete API reference for ATick for Python — every function, option and attribute.', alternates: { canonical: '/docs/python/api/' } };
