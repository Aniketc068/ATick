...
export function DocsShell({ lang, section = "", children }: { lang: string; section?: string; children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-dvh">
      ...
      <div className="container-x grid grid-cols-1 gap-10 py-10 lg:grid-cols-[15rem_minmax(0,1fr)]">
        <aside className="lg:sticky lg:top-24 lg:h-[calc(100dvh-7rem)] lg:overflow-y-auto">
